...
export class GUIDriver {
    ...
    setupCanvas(){
         ...
         */
        const lsCanvasW = localStorage.getItem("V10_CANVAS_WIDTH");
        const lsCanvasH = localStorage.getItem("V10_CANVAS_HEIGHT");
        ...
        localStorage.setItem("V10_CANVAS_WIDTH",  this.canvasLargeMandelbrot.width);
        localStorage.setItem("V10_CANVAS_HEIGHT", this.canvasLargeMandelbrot.height);
    ...
    setupEventhandlers(){
        this.elmCanvasWidthSlider.addEventListener("change", () => {
            ...
            localStorage.setItem("V10_CANVAS_WIDTH", w);
        ...
        this.elmCanvasHeightSlider.addEventListener("change", () => {
            ...
            localStorage.setItem("V10_CANVAS_HEIGHT", h);
