...
export class GUIDriver {
    ...
    setupCanvas(){
         ...
         */
        const lsCanvasW = localStorage.getItem("V7_CANVAS_WIDTH");
        const lsCanvasH = localStorage.getItem("V7_CANVAS_HEIGHT");
        ...
        localStorage.setItem("V7_CANVAS_WIDTH",  this.canvasLargeMandelbrot.width);
        localStorage.setItem("V7_CANVAS_HEIGHT", this.canvasLargeMandelbrot.height);
    ...
    setupGUIElements() {
         ...
         */
        this.canvasLargeMandelbrot = document.getElementById('fractal');
    ...
    setupEventhandlers(){
        ...
        document.getElementById("btnExport").addEventListener("click", () => {
            ...
            this.constantsExport.updateCanvas(this.canvasExportM);
