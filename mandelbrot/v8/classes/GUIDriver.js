...
export class GUIDriver {
    ...
    setupCanvas(){
         ...
         */
        const lsCanvasW = localStorage.getItem("V8_CANVAS_WIDTH");
        const lsCanvasH = localStorage.getItem("V8_CANVAS_HEIGHT");
        ...
        localStorage.setItem("V8_CANVAS_WIDTH",  this.canvasLargeMandelbrot.width);
        localStorage.setItem("V8_CANVAS_HEIGHT", this.canvasLargeMandelbrot.height);
