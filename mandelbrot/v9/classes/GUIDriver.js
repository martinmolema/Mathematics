...
export class GUIDriver {
    ...
    setupCanvas(){
         ...
         */
        const lsCanvasW = localStorage.getItem("V9_CANVAS_WIDTH");
        const lsCanvasH = localStorage.getItem("V9_CANVAS_HEIGHT");
        ...
        localStorage.setItem("V9_CANVAS_WIDTH",  this.canvasLargeMandelbrot.width);
        localStorage.setItem("V9_CANVAS_HEIGHT", this.canvasLargeMandelbrot.height);
