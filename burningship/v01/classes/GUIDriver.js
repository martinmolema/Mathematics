...
import {BurningShipSmartDrawer} from "./BurningShipSmartDrawer.js";
import {IterationLines} from "./IterationLines.js";
import {SVGSupport} from "./SVGSupport.js";

const INITIAL_FRACTAL_PLAIN_WIDTH = 6;
...
export class GUIDriver {
    ...
    constructor(maxIterations) {
        ...
        this.drawerLargeMandelbrot  = new BurningShipSmartDrawer ( this.constantsMandelbrotLarge, this.palettes, maxIterations, 'mandelbrotlarge');
        this.drawerZoom             = new BurningShipSmartDrawer ( this.constantsPreview,         this.palettes, maxIterations, 'zoom');
        this.drawerExportMandelbrot = new BurningShipSmartDrawer ( this.constantsExportM,         this.palettes, maxIterations, 'exportMandelbrot');
    ...
    initConstants(){
        ...
        this.adjustCanvasDimensions(INITIAL_FRACTAL_PLAIN_WIDTH);
